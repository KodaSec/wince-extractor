...
def set_to_image_start(in_f: BinaryIO, byteorder: str) -> None:
    """
...
class WinCEExtractor(object):
    ...
    def extract_data(self, out_f: BinaryIO, offset: int, datasize: int, is_compressed: bool, max_uncompressed_size: int) -> int:
        """
...
class WinEntry(object):
    ...
    """
    def __init__(self, extractor: WinCEExtractor, entry: Union[toc_entry, file_entry]):
        self.extractor  = extractor
        self.entry      = entry
        self.file_name  = read_null_terminated_string(self.extractor.data, self.extractor.minus_load_offset(self.entry.lpszFileName))
...
class WinFile(WinEntry):
    def __init__(self, extractor: WinCEExtractor, entry: file_entry):
...
class WinModule(WinEntry):
    ...
    def __init__(self, extractor: WinCEExtractor, toc: toc_entry, rom: romhdr):
        ...
        for i in range(self.e32.e32_objcnt):
            self.o32_roms.append(load_from_offset(self.extractor.data, self.o32_offset + (ctypes.sizeof(o32_rom) * i), o32_rom))
    ...
    def write_to(self, out_f: BinaryIO) -> None:
        ...
        for o32_s in self.o32_roms:
            ...
            data_len = self.extractor.extract_data(out_f, self.extractor.minus_load_offset(o32_s.o32_dataptr), min(o32_s.o32_vsize, o32_s.o32_psize), 
    ...
    def __calculate_segment_size_sum(self, segtype_flag: int) -> int:
        ...
        :param segtypeflag: a flag of some sort
